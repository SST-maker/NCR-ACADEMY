    ...
    app.innerHTML = `
      <main class="login-screen">
        <section class="login-card glass-panel">
          ...
          <p class="lead small">L’application a rencontré une erreur de chargement. Vide le cache puis recharge la page.</p>
...
window.addEventListener('hashchange', function onHashChange() {
  render().catch(function renderError(error) {
...
window.addEventListener('DOMContentLoaded', function ready() {
  ...
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('./service-worker.js?fresh=' + Date.now()).then(function registered(registration) {
